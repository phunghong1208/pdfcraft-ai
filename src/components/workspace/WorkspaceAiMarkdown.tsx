...
const PROSE_CLASS = [
  ...
  '[&_em]:text-violet-200/90',
  '[&_a]:text-blue-300 [&_a]:underline [&_a]:underline-offset-2',
  '[&_blockquote]:border-l-2 [&_blockquote]:border-violet-500/40 [&_blockquote]:pl-3 [&_blockquote]:my-2 [&_blockquote]:text-white/60 [&_blockquote]:italic',
...
export function WorkspaceAiMarkdown({ content, className = '' }: WorkspaceAiMarkdownProps) {
  const html = useMemo(() => {
